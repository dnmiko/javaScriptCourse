...
//console.log(plane[2]);
const stringLength = airline.length;
console.log(airline.indexOf('r'));
console.log(airline.lastIndexOf('r'));
console.log(airline.indexOf('Portugal'));

//Whenever we pass a negative value to slice it counts backwards, so -1 is the last character of the string
console.log(plane.slice(-1));

const upperString = airline.toUpperCase();
const lowerString = airline.toLowerCase();

//Fix capitalization in String
const passengerName = 'jOnAs';
const nameLower = passengerName.toLowerCase();
const correctName = nameLower[0].toUpperCase() + nameLower.slice(1);

//Replace characters from a String
const priceGB = '288,96&';
const priceMX = priceGB.replace('&', '$').replace(',', '.');

//console.log(priceMX);

//Split a String based on an specific character
const [firstName, lastName] = 'Diego Cifuentes'.split(' ');
